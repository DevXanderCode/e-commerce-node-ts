...
const postAddProduct = (req, res, _next) => {
    ...
    const product = new models_1.Product(title, price, description, imageUrl, "", req.user._id);
    product
        .save()
        .then(() => res.redirect("/"))
...
const postEditProduct = (req, res, _next) => {
    ...
    const product = new models_1.Product(title, price, description, imageUrl, prodId);
...
const postDeleteProduct = (req, res, _next) => {
    ...
    models_1.Product.deleteById(prodId)
        .then(() => {
